...
local items = {
	...
	["item_recipe_wraith_band"]		 = { [1] = 30, [2] = 1, [3] = 1, [4] = 1 },
	["item_recipe_bracer"]			 = { [1] = 30, [2] = 1, [3] = 1, [4] = 1 },
	["item_recipe_null_talisman"]	 = { [1] = 30, [2] = 1, [3] = 1, [4] = 1 },
	...
	["item_eclipse_amphora"]		 = { [1] = 45, [2] = 1, [3] = 1, [4] = 5 },
...
function SetBossessDrop(monster_table, item_table)
	SetMonsterDropOfTable(monster_table, "npc_dota_custom_guardian", "item_tome_lvlup", item_table)
	SetMonsterDropOfTable(monster_table, "npc_dota_custom_guardian", "item_tome_agi_3", item_table)
	SetMonsterDropOfTable(monster_table, "npc_dota_custom_guardian", "item_tome_int_3", item_table)
	SetMonsterDropOfTable(monster_table, "npc_dota_custom_guardian", "item_tome_str_3", item_table)
	SetMonsterDropOfTable(monster_table, "npc_dota_custom_guardian", "item_tome_un_3", item_table)
	...
	SetMonsterDropOfTable(monster_table, "npc_dota_custom_guardian", "item_eclipse_amphora", item_table)
	...
	SetMonsterDropOfTable(monster_table, "npc_angel_of_hate", "item_tome_med", item_table)
	SetMonsterDropOfTable(monster_table, "npc_angel_of_hate", "item_tome_agi_6", item_table)
	SetMonsterDropOfTable(monster_table, "npc_angel_of_hate", "item_tome_int_6", item_table)
	SetMonsterDropOfTable(monster_table, "npc_angel_of_hate", "item_tome_str_6", item_table)
	SetMonsterDropOfTable(monster_table, "npc_angel_of_hate", "item_tome_un_6", item_table)
	...
	SetMonsterDropOfTable(monster_table, "npc_boss_travaler", "item_aegis", item_table)
...
SetMonstersDropByLevel(monsters, 1, "item_recipe_wraith_band", items)
SetMonstersDropByLevel(monsters, 1, "item_recipe_bracer", items)
SetMonstersDropByLevel(monsters, 1, "item_recipe_null_talisman", items)
